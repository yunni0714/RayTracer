...
export const SVG_ART: Record<PieceType, string> = {
  ...
  tunnel: `<svg viewBox="0 0 100 100"><path d="M22 32 V68 M78 32 V68" stroke="currentColor" stroke-width="8" stroke-linecap="square"/><path d="M22 40 L38 50 L22 60 Z M78 40 L62 50 L78 60 Z" fill="none" stroke="currentColor" stroke-width="6" stroke-linejoin="miter"/></svg>`,
  ...
  diode: `<svg viewBox="0 0 100 100"><path d="M14 36 V64" stroke="currentColor" stroke-width="7" stroke-linecap="square"/><path d="M14 42 L28 50 L14 58 Z" fill="none" stroke="currentColor" stroke-width="6" stroke-linejoin="miter"/><path d="M28 50 L40 32 L56 68 L72 50" fill="none" stroke="currentColor" stroke-width="6" stroke-linejoin="miter"/><path d="M86 22 V78" stroke="currentColor" stroke-width="7" stroke-linecap="square"/><path d="M86 42 L72 50 L86 58 Z" fill="none" stroke="currentColor" stroke-width="6" stroke-linejoin="miter"/></svg>`,
  ...
  transistor_gate: `<svg viewBox="0 0 100 100"><path d="M50 16 V58" stroke="currentColor" stroke-width="8" stroke-linecap="square"/><path d="M24 42 L50 16 L76 42" fill="none" stroke="currentColor" stroke-width="8" stroke-linejoin="miter"/><path d="M50 58 l10 11 -10 11 -10 -11 Z" fill="none" stroke="currentColor" stroke-width="7" stroke-linejoin="miter"/><path d="M40 69 L28 82 M60 69 L72 82" stroke="currentColor" stroke-width="7" stroke-linecap="square"/></svg>`,
  cross_gate: `<svg viewBox="0 0 100 100"><path d="M24 22 V46 M54 24 H78 M76 78 V54 M46 76 H22" stroke="currentColor" stroke-width="6" stroke-linecap="square"/><path d="M24 22 L37 27 L24 32 Z M78 24 L73 37 L68 24 Z M76 78 L63 73 L76 68 Z M22 76 L27 63 L32 76 Z" fill="none" stroke="currentColor" stroke-width="5" stroke-linejoin="miter"/></svg>`,
